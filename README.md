...
- **The Corona — *Sunfire Sweep*:** a searing beam pivots from a point off to
...
- **42 achievements** with shard rewards and long-term goals — survive 15:00 to
  ...
  signature playstyles: 100 executes (*Harvester*), 60 rifts (*Riftborn*), 3000
  damage reflected (*Unbroken*).
...
| 🌘 **Eventide** | the Abyss, played as the **Pyre** — berserk & frail | Score 180,000 | Warden's End |
